...
//this will echo hash in hex, then binary
echo $phasher->hashAsString($phash3, false).PHP_EOL; // BITS
echo $phasher->hashAsString($phash3).PHP_EOL; // hamming

//using BIT COUNT METHOD FOR SIMILARITY
echo $phasher->getSimilarity($phash2, $phash3, 'BITS'); // % совпадения
echo PHP_EOL;
