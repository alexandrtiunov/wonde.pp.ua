    ...
    <form  method="post" action="{{action('Admin\NewsController@store')}}" enctype="multipart/form-data" >
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="short_name" placeholder="Exemple: novost_dnya" >
            </div>
        </div>
        <div class="row">
            <div class="col-md-4"></div>
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="content" placeholder="Type content" >
            </div>
        </div>
        <div class="row">
            <div class="col-md-4"></div>
